...
const RamblApp = () => {
  ...
  const updateNavigation = () => {
    // This will be handled by React's conditional rendering
  };
  ...
  const renderCurrentScreen = () => {
    ...
    if (currentScreen === 'loginScreen' || currentScreen === 'signupScreen') {
      return (
        <div className="app-container" style={{ display: 'block' }}>
          {currentScreen === 'loginScreen' ? <LoginScreen /> : <SignupScreen />}
        </div>
      );
    }
    ...
    return (
      <div className="app-container" style={{ display: 'block' }}>
        ...
        {currentScreen === 'promptScreen' && <PromptScreen />}
        {currentScreen === 'analyticsScreen' && <AnalyticsScreen />}
        {currentScreen === 'libraryScreen' && <LibraryScreen />}
        {currentScreen === 'settingsScreen' && <SettingsScreen />}
        {currentScreen === 'timelineScreen' && <TimelineScreen />}
      </div>
    );
  };
